...
async function collectResults(): Promise<{
  ...
  // Dashboard "Right now" / "Over time" surface (feat/dashboard-safe-to-spend).
  ...
  await run(results, "Dashboard", "getCashflowChart()", "success", () => getCashflowChart());
  await run(results, "Dashboard", "getRangeCashflowStats() -- MTD", "success", () =>
    getRangeCashflowStats(dashRange),
  );
  await run(results, "Dashboard", "getGroupMovement() -- MTD", "success", () =>
    getGroupMovement(dashRange),
  );
